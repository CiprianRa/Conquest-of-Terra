...
public class Chainer extends Enemy{

    public Chainer(float x, float y) {
        super(x, y, 64, 64, CHAINER);
        initHitbox(x,y,(int)(40),(int)(40));
        initAttackBox();
    }

    private void initAttackBox() {
        attackBox=new Rectangle2D.Float(x,y,(int)(55*Game.SCALE),(int)(20*Game.SCALE));
    }
        ...
        else
        {
            switch(state)
            {
                ...
                case ATTACKING:
                    if(aniIndex==0)
                        attackChecked=false;
                    if(!attackChecked && aniIndex==3 || aniIndex==6)
